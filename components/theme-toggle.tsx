...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <Button variant="outline" size="icon" disabled className="border-border/50 bg-transparent h-8 w-8">
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggleTheme}
      className="border-border/50 bg-transparent hover:bg-accent/40 transition-colors h-8 w-8"
    >
